...
local MainGroup   = MainTab:CreateGroupbox("All Features")
local CombatGroup = CombatTab:CreateGroupbox("Combat Options")
local VisualGroup = VisualTab:CreateGroupbox("Visual Settings")
